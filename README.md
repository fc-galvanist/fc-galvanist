...
We are the Ferric Collective.

Our Manifesto:
1.  Imperfection is a feature - We believe that the natural variability of hardware [Valves, Transistors]
...
7.  We use cryptography to authenticate, not obfuscate
8.  We are slightly dramatic - We embrace the design of equipment that feels 'eldritch', we use iron, steel, voodoo.
    We cast spells in code, out native language is C++, our liturgical language is Fortran
    We design floating displays, dramatic lighting, equipment that is unique and batch numbered.  We use solid wood panel when veneered plywood would do.
